<?php
    ...
    class Locale
    {
         ...
         */
        public static function getDialCode($country) {
            $country = Locale::getCountryInformation($country);
            return $country !== false ? $country['dial_code'] : false;
        }
         ...
         */
        public static function getCountryInformation($country)
        {
            $country = strtoupper($country);

            return isset(Locale::$countries[$country]) ? Locale::$countries[$country] : false;
        }
