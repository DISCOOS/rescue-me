...
R.track.locate = function() {
    ...
    function showPosition(position) {
        ...
        var attempt = isNaN(attempt = parseInt(query.attempt)) ? 1 : attempt;

        if (y.accuracy > 500 && attempt < 10)
            recalc = true;
        else
            recalc = false;
        ...
        var url = R.app.url + "r/" + query.id + "/" + query.phone + "/" + (attempt + 1) + "/" + y.latitude + "/" + y.longitude + "/" + y.accuracy + "/" + y.altitude;
