<?php
    ...
    // Load RescueMe minify configuration
    require '../config.minify.php';
     ...
     */
    $min_serveOptions['maxAge'] = 0; //1800;
     ...
     * issue without changing the variable below. Under logon > environment, 
