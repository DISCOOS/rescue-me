<?php
    ...
    define('SMS_TEXT', 'TEST: Du er savnet! <br /> Trykk p̴ lenken for at vi skal se hvor du er: <br /> '.APP_URL.'#missing_id-#to');
    define('SMS_NOT_SENT', 'OBS: Varsel ble ikke sendt til "#mb_name"');
    define('SMS2_TEXT', 'Om du har GPS p̴ telefonen, anbefaler vi at du aktiverer dette. Vanligvis finner du dette under Innstillinger -> Generelt, eller Innstillinger -> Plassering');
    define('SMS_MB_TEXT', 'Mottatt posisjon p̴ "#m_name" (+/- #acc meter)! '.APP_URL.'admin/missing/details/#missing_id');
